 ...
 */
public class RecommendGroupsAdapter extends BaseQuickAdapter<RecommendGroupsBean.DataBean, BaseViewHolder> {
    private OnItemClickListener onItemClickListener;
    private OnItemLongClickListener onItemLongClickListener;
    private OnTextViewClickListener onTextViewClickListener;

    public RecommendGroupsAdapter() {
    ...
    @Override
    protected void convert(BaseViewHolder helper, RecommendGroupsBean.DataBean item) {
        try {
