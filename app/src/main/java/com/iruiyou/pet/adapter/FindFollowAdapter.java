 ...
 * 发现-关注 列表
 */
public class FindFollowAdapter extends RecyclerView.Adapter<FindFollowAdapter.MyViewHolder> {
    ...
    public FindFollowAdapter(Context context, List<GetEssaysBean.DataBean> data) {
    ...
    @Override
    public FindFollowAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = Objects.requireNonNull(inflater).inflate(R.layout.item_recycler_find_follow, parent, false);
        return new FindFollowAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final FindFollowAdapter.MyViewHolder holder, int position) {
