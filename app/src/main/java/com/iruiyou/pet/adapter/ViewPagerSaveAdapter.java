...
public class ViewPagerSaveAdapter extends PagerAdapter {

    private Context context;
    private List<GetEssaysBean.DataBean.ImagesBean> imgList; //图片的数据源

    public ViewPagerSaveAdapter(Context context, List<GetEssaysBean.DataBean.ImagesBean> imgList) {
    ...
    public Object instantiateItem( ViewGroup container, int position) {
        ...
        Glide.with(context).load(BaseApi.baseUrlNoApi + imgList.get(position).getPath()).into(imageView);
