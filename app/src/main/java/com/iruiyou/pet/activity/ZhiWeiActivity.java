...
public class ZhiWeiActivity extends BaseActivity {
    ...
    public int getLayout() {
        return R.layout.fragment_clessess;
    }
    ...
    public void OnActCreate(Bundle savedInstanceState) {
        ...
        positionListAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                StartActivityManager.startPositionDetailActivity(ZhiWeiActivity.this,dataBean);
...
//                startActivity(intent);
        ...
        courseContentAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (data != null) {
                    Intent intent = new Intent(ZhiWeiActivity.this, CourseContentActivity.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("getCourseIntroBean", data);
                    intent.putExtras(bundle);
                    Objects.requireNonNull(ZhiWeiActivity.this).startActivity(intent);
                }
            }
        });
        ...
        new UserTask(new HttpOnNextListener() {
            ...
            public void onNext(String resulte, String method) {
                ...
                if (recomendsBean.getStatusCode() == Constant.SUCCESS) {
                    ...
                    findElitesAdapter = new FindElitesAdapter(ZhiWeiActivity.this, data);
                    ...
                    findElitesAdapter.setItemClickListener(new FindElitesAdapter.MyItemClickListener() {
                        ...
                        public void onItemClick(int position) {
                            ...
                            bundle.putInt("userid", recomendsBean.getData().get(position).getBasicInfo().getUserId());
                            bundle.putString("realName", recomendsBean.getData().get(position).getBasicInfo().getRealName());//get(position).getBasicInfo().getRealName()
                            Intent intent = new Intent(ZhiWeiActivity.this, UserDetailsActivity.class);
                            intent.putExtras(bundle);
                            startActivity(intent);
                        }
                    });
            ...
            public void onNext(String resulte, String method) {
                if (StringUtil.isNotEmpty(resulte)) {
                    ...
                    if (Constant.SUCCESS == doumiOptionBean.getStatusCode()) {
                        ...
                        spinner_position_area.setAdapter(new PositionSpinnerAdapter(ZhiWeiActivity.this, doumiOptionBean.getData().getDomain()));

                        currentArea = doumiOptionBean.getData().getJob_type().get(0);
                        spinner_position_class.setAdapter(new PositionSpinnerAdapter(ZhiWeiActivity.this, doumiOptionBean.getData().getJob_type()));

                        currentQuanzhi = doumiOptionBean.getData().getJob_date_type().get(0);
                        spinner_position_quanzhi.setAdapter(new PositionSpinnerAdapter(ZhiWeiActivity.this, doumiOptionBean.getData().getJob_date_type()));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.resumeLFind:
                ...
                Intent intent = new Intent(ZhiWeiActivity.this, CombatRankingActivity.class);
