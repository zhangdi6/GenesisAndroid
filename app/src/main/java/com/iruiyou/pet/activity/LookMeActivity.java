...
//        recommendGroupsRecyclerView.setLayoutManager(new MyLinearLayoutManager(getContext()));
         ...
         * 设置会话列表界面操作的监听器。
         */
        RongIM.setConversationListBehaviorListener(new LookMeActivity.MyConversationListBehaviorListener());
...
//        });
        ...
        linear_friend_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StartActivityManager.startFriendApplication(LookMeActivity.this);
            }
        });
        ...
        ll_recommendGroups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                StartActivityManager.startRecommendGroupsActivity(LookMeActivity.this);
            }
        });
        //消息按钮
        ...
        registerPresenter.getOccupationsList(new ResultDataLinsenter() {
            ...
            public void success(Object o) {
                if (o != null) {
                    ...
                    occupationAdapter = new OccupationAdapter(LookMeActivity.this, occupationBeens, 3);
...
//                    recommendGroupsRecyclerView.setAdapter(recommendGroupsAdapter);
    ...
    public void onDestroy() {
        ...
        BroadcastManager.getInstance(LookMeActivity.this).destroy(Constant.FANS_GONE);
        BroadcastManager.getInstance(LookMeActivity.this).destroy(Constant.FANS_VISIBLE);
    }
...
//            int conversationTarget = Integer.parseInt(split[1]);
            ...
            //弹出的“保存图片”的Dialog
            AlertDialog.Builder builder = new AlertDialog.Builder(Objects.requireNonNull(LookMeActivity.this));
