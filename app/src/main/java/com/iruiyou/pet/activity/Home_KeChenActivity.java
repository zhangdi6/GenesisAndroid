...
public class Home_KeChenActivity extends BaseActivity {
    ...
    public void OnActCreate(Bundle savedInstanceState) {
        ...
        findRecyclerView = findViewById(R.id.findRecyclerView);//精英推荐列表
        workplace_course_RecyclerView = findViewById(R.id.workplace_course_RecyclerView);//职场课程列表
        course_content_recyclerView = findViewById(R.id.course_content_RecyclerView);//课程内容列表
        resumeLFind = findViewById(R.id.resumeLFind);//精英推荐
        ll_workplace_course = findViewById(R.id.ll_workplace_course);//职场课程
        scrollView_workplace = findViewById(R.id.scrollView_workplace);
        refreshLayout_find = findViewById(R.id.refreshLayout_find);
        im_no_courses = findViewById(R.id.im_no_courses);
        ...
        //职场课程
        workplaceCourseAdapter = new WorkplaceCourseAdapter(this, courseList);
        ...
        course_content_recyclerView.setLayoutManager(new MyLinearLayoutManager(this));
        ...
        positionListAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                StartActivityManager.startPositionDetailActivity(Home_KeChenActivity.this,dataBean);
//                Toast.makeText(getContext(),"---------"+position,Toast.LENGTH_SHORT).show();
            }
        });
        recycle_position.setLayoutManager(new LinearLayoutManager(this));
        recycle_position.addItemDecoration(new RecycleViewDivider(this, LinearLayoutManager.HORIZONTAL,
                Utils.dip2px(this, 2), getResources().getColor(R.color._f1f1f1)));


        //设置 Footer 为 经典式样
        refreshLayout_position.setRefreshFooter(new ClassicsFooter(Objects.requireNonNull(this)).setSpinnerStyle(SpinnerStyle.Scale));
        //刷新操作
...
//                    courseContentAdapter.setNewData(data);
        ...
        }, (BaseActivity) this).getCourseIntro(categoryId, lastCount);
    ...
    private void setListener() {
        ...
        //设置 Footer 为 经典式样
        refreshLayout_find.setRefreshFooter(new ClassicsFooter(Objects.requireNonNull(this)).setSpinnerStyle(SpinnerStyle.Scale));
        //刷新操作
...
//                startActivity(intent);
        ...
        courseContentAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (data != null) {
                    Intent intent = new Intent(Home_KeChenActivity.this, CourseContentActivity2.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("getCourseIntroBean", data);
                    bundle.putSerializable("CourseIntroPosition", position);
                    intent.putExtras(bundle);
                    Objects.requireNonNull(Home_KeChenActivity.this).startActivity(intent);
                }
            }
        });
    ...
    private void getData() {
        ...
        new UserTask(new HttpOnNextListener() {
            ...
            public void onNext(String resulte, String method) {
                ...
                if (recomendsBean.getStatusCode() == Constant.SUCCESS) {
                    ...
                    findElitesAdapter = new FindElitesAdapter(Home_KeChenActivity.this, data);
                    ...
                    findElitesAdapter.setItemClickListener(new FindElitesAdapter.MyItemClickListener() {
                        ...
                        public void onItemClick(int position) {
                            ...
                            bundle.putInt("userid", recomendsBean.getData().get(position).getBasicInfo().getUserId());
                            bundle.putString("realName", recomendsBean.getData().get(position).getBasicInfo().getRealName());//get(position).getBasicInfo().getRealName()
                            Intent intent = new Intent(Home_KeChenActivity.this, UserDetailsActivity.class);
                            intent.putExtras(bundle);
                            startActivity(intent);
        ...
        }, (BaseActivity)this).getRecomends();
            ...
            public void onNext(String resulte, String method) {
                if (StringUtil.isNotEmpty(resulte)) {
                    ...
                    if (Constant.SUCCESS == doumiOptionBean.getStatusCode()) {
                        ...
                        spinner_position_area.setAdapter(new PositionSpinnerAdapter(Home_KeChenActivity.this, doumiOptionBean.getData().getDomain()));

                        currentArea = doumiOptionBean.getData().getJob_type().get(0);
                        spinner_position_class.setAdapter(new PositionSpinnerAdapter(Home_KeChenActivity.this, doumiOptionBean.getData().getJob_type()));

                        currentQuanzhi = doumiOptionBean.getData().getJob_date_type().get(0);
                        spinner_position_quanzhi.setAdapter(new PositionSpinnerAdapter(Home_KeChenActivity.this, doumiOptionBean.getData().getJob_date_type()));
        ...
        }, (BaseActivity) this).getPositionOptions();
    ...
    private void requestPositionData(String domain, String job_type, int job_date_type, int page, boolean isInit) {
        ...
        }, (BaseActivity) this).getDoumiPositionList(domain, job_type, job_date_type, page);
    }




    @OnClick({R.id.resumeLFind})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.resumeLFind:
                ...
                Intent intent = new Intent(Home_KeChenActivity.this, CombatRankingActivity.class);
