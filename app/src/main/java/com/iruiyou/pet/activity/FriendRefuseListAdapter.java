...
public class FriendRefuseListAdapter extends BaseQuickAdapter<GetAppListBean.ApplyBean, BaseViewHolder> {
    ...
    public FriendRefuseListAdapter(boolean isMine, Context context) {
        super(R.layout.adapter_friend_refuse);
        this.isMine=isMine;
