...
//        recommendGroupsRecyclerView.setLayoutManager(new MyLinearLayoutManager(getContext()));
        ...
        //接收广播-隐藏红点
        BroadcastManager.getInstance(this).addAction(Constant.FANS_GONE, new BroadcastReceiver() {
            @Override
        ...
        //接收广播我有新的粉丝了-显示红点
        BroadcastManager.getInstance(this).addAction(Constant.FANS_VISIBLE, new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                String command = intent.getAction();
                if (!TextUtils.isEmpty(command)) {
        ...
        Uri uri = Uri.parse("rong://" + Objects.requireNonNull(this).getApplicationInfo().packageName).buildUpon()
         ...
         * 设置会话列表界面操作的监听器。
         */
        RongIM.setConversationListBehaviorListener(new MessageActivity.MyConversationListBehaviorListener());
...
//        });
        ...
        linear_friend_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StartActivityManager.startFriendApplication(MessageActivity.this);
            }
        });
        ...
        ll_recommendGroups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                StartActivityManager.startRecommendGroupsActivity(MessageActivity.this);
            }
        });
        //消息按钮
        ...
        //接收广播好友申请-显示红点
        BroadcastManager.getInstance(this).addAction(Constant.APPLY_VISIBLE, new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                String command = intent.getAction();
                if (!TextUtils.isEmpty(command)) {
        ...
        seeMeAdapter = new SeeMeAdapter(this);
        recyle_see_me.setLayoutManager(new MyLinearLayoutManager(this));
        ...
        friendRecyclerView.setLayoutManager(new MyLinearLayoutManager(this));
        ...
        registerPresenter.IPresenter(this);
        ...
        registerPresenter.getOccupationsList(new ResultDataLinsenter() {
            ...
            public void success(Object o) {
                if (o != null) {
                    ...
                    occupationAdapter = new OccupationAdapter(MessageActivity.this, occupationBeens, 3);
...
//        getApplyMeAndMyApply();
    ...
    @OnClick(value = {R.id.text_chat, R.id.mine_interaction, R.id.text_see_me})
...
//                refreshLayout_new_friends.setVisibility(View.GONE);
    ...
    private void getRefresh() {
        //设置 Footer 为 经典式样
        refreshLayout_see_me.setRefreshFooter(new ClassicsFooter(Objects.requireNonNull(this)).setSpinnerStyle(SpinnerStyle.Scale));
        //刷新操作
...
//                        tvMyFriends.setText(getString(R.string.my_friend) + "(" + checkFriendsBean.getData().size() + ")");
        ...
        }, ((RxAppCompatActivity)this)).getFriends();
...
//                    recommendGroupsRecyclerView.setAdapter(recommendGroupsAdapter);
    ...
    public void onDestroy() {
        ...
        BroadcastManager.getInstance(MessageActivity.this).destroy(Constant.FANS_GONE);
        BroadcastManager.getInstance(MessageActivity.this).destroy(Constant.FANS_VISIBLE);
    }
...
//            int conversationTarget = Integer.parseInt(split[1]);
            ...
            //弹出的“保存图片”的Dialog
            AlertDialog.Builder builder = new AlertDialog.Builder(Objects.requireNonNull(MessageActivity.this));
...
//                                                    disturb = getString(R.string.cancel_no_bother);
    ...
    private void getSeeMeData(){
        new UserTask(new HttpOnNextListener() {
            ...
            public void onNext(String resulte, String method) {
                ...
                if(StringUtil.isNotEmpty(resulte)){
                   ...
                   /* setAccessCount(seeMeLogBean.getData().getLogs().size());*/
                }
        ...
        }, this).findFriendLog(SharePreferenceUtils.getBaseSharePreference().readBasicId());
    }
