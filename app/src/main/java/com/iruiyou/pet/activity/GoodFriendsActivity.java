...
//        recommendGroupsRecyclerView.setLayoutManager(new MyLinearLayoutManager(getContext()));
         ...
         * 设置会话列表界面操作的监听器。
         */
        RongIM.setConversationListBehaviorListener(new GoodFriendsActivity.MyConversationListBehaviorListener());
...
//        });
        ...
        linear_friend_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StartActivityManager.startFriendApplication(GoodFriendsActivity.this);
            }
        });
        ...
        ll_recommendGroups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                StartActivityManager.startRecommendGroupsActivity(GoodFriendsActivity.this);
            }
        });
        //消息按钮
        ...
        registerPresenter.getOccupationsList(new ResultDataLinsenter() {
            ...
            public void success(Object o) {
                if (o != null) {
                    ...
                    occupationAdapter = new OccupationAdapter(GoodFriendsActivity.this, occupationBeens, 3);
...
//                    recommendGroupsRecyclerView.setAdapter(recommendGroupsAdapter);
    ...
    public void onDestroy() {
        ...
        BroadcastManager.getInstance(GoodFriendsActivity.this).destroy(Constant.FANS_GONE);
        BroadcastManager.getInstance(GoodFriendsActivity.this).destroy(Constant.FANS_VISIBLE);
    }
...
//            int conversationTarget = Integer.parseInt(split[1]);
            ...
            //弹出的“保存图片”的Dialog
            AlertDialog.Builder builder = new AlertDialog.Builder(Objects.requireNonNull(GoodFriendsActivity.this));
