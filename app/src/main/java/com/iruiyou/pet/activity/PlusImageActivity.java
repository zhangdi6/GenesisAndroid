...
import com.iruiyou.pet.adapter.ViewPagerAdapter;
...
public class PlusImageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPosition = getIntent().getIntExtra(Constant.POSITION_PIC, 0);
        initView();
    }
    ...
    private void deletePic() {
        CancelOrOkDialog dialog = new CancelOrOkDialog(this, "您确定要删除这张图片吗?") {
            @Override
            public void ok() {
                super.ok();
    ...
    private void back() {
        ...
        intent.putStringArrayListExtra(Constant.IMG_LIST, imgList);
