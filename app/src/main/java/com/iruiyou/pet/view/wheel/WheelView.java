...
//import com.oldfriend.develop.R;
//import com.oldfriend.develop.utils.DensityUtil;

import com.iruiyou.pet.R;
import com.iruiyou.pet.utils.DensityUtil;
...
//					| Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val_new);
		}
...
//		valuePaint.setColor(VALUE_TEXT_COLOR);
		...
		valuePaint.setColor(getResources().getColor(R.color._333333));
...
//		itemsPaint.setColor(ITEMS_TEXT_COLOR);
		itemsPaint.setColor(getResources().getColor(R.color._999999));
