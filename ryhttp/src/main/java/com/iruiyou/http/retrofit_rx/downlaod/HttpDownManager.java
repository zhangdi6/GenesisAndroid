package com.iruiyou.http.retrofit_rx.downlaod;

import com.iruiyou.http.retrofit_rx.downlaod.DownLoadListener.DownloadInterceptor;
...
import com.iruiyou.http.retrofit_rx.subscribers.ProgressDownSubscriber;
import com.iruiyou.http.retrofit_rx.utils.DbDwonUtil;
...
import static com.iruiyou.http.retrofit_rx.utils.AppUtil.getBasUrl;
import static com.iruiyou.http.retrofit_rx.utils.AppUtil.writeCache;
...
public class HttpDownManager {
    ...
    public void startDown(final DownInfo info){
        ...
        if(info==null||subMap.get(info.getUrl())!=null){
            subMap.get(Objects.requireNonNull(info).getUrl()).setDownInfo(info);
            return;
        }
        /*添加回调处理类*/
