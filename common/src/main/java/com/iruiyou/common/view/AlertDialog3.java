...
public class AlertDialog3 {
    ...
    public AlertDialog3 builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.view_alert_dialog3, null);
    ...
    public AlertDialog3 setTitle(String title) {
        txt_title.setText(title);
        return this;
    }

    public AlertDialog3 setonEditTextListener(final OnEditTextListener listener) {
    ...
    public AlertDialog3 setCancelable(boolean cancel) {
